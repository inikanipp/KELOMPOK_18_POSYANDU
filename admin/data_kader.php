...
<body>
  ...
  <div class="sidebar d-flex flex-column p-3">
    ...
    <ul class="nav nav-pills flex-column">
      ...
      <li class="nav-item"><a href="data_kader.php" class="nav-link active">Data Kader</a></li>
  ...
  <div class="content">
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        <div class="mb-3">
          <a href="tambah_kader.php" class="btn btn-success"><i class="bi bi-plus-circle"></i> Tambah Kader</a>
        </div>
            ...
            <tbody>
              ...
              if ($result->num_rows > 0) {
                  ...
                  while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<td>" . $row['byk_anak'] . "</td>";
                      echo "<td>" . htmlspecialchars($row['no_hp']) . "</td>";
                      echo "<td>" . htmlspecialchars($row['status_kader']) . "</td>";
                      echo "<td><a href='edit_kader.php?id={$row['id_kader']}' class='btn btn-sm btn-primary'><i class='bi bi-pencil-square'></i></a></td>";
                      echo "</tr>";
                  }
              } else {
                  echo "<tr><td colspan='6' class='text-center'>Data kader belum tersedia</td></tr>";
              }
              ?>
            </tbody>
          </table>
